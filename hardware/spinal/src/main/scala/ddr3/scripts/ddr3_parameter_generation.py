...
for density in densities:
    ...
    for speed_grade in speed_grades:
        for width in widths:
            for rank in ranks:
                process = subprocess.Popen(f"iverilog -I {script_path}/../../../../../../sim/lib/DDR3_SDRAM_Verilog_Model -D {density} -D {speed_grade} -D {width} {script_path}/ddr3_parameter_generation.v -o {script_path}/ddr3_parameter_generation && vvp {script_path}/ddr3_parameter_generation",
