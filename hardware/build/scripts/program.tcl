...
# set probes "set_property PROBES.FILE \{${output_dir}/top.ltx\} \[get_hw_devices xc7a*\]"
# eval ${probes}
# set proves "set_property FULL_PROBES.FILE \{${output_dir}/top.ltx\} \[get_hw_devices xc7a*\]"
# eval ${probes}
