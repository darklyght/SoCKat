...
read_verilog [ glob $hardware_root/src/hdl/top/Top.v ]
read_xdc [ glob $hardware_root/src/constraints/*.xdc ]

set_property part xc7a200tsbg484-1 [ current_project ]

# add_files $hardware_root/src/ip/MemoryController/MemoryController.xci
# generate_target all [ get_files *MemoryController.xci ]
# synth_ip [ get_files *MemoryController.xci ]

synth_design -top Top -part xc7a200tsbg484-1 -directive PerformanceOptimized
