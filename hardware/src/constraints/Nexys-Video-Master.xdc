...
set_property -dict { PACKAGE_PIN R4    IOSTANDARD LVCMOS33 } [get_ports { topClock_clk }]; #IO_L13P_T2_MRCC_34 Sch=sysclk
#create_clock -add -name sys_clk_pin -period 10.00 -waveform {0 5} [get_ports clk]
create_clock -add -name sys_clk_pin -period 10.00 -waveform {0 5} [get_ports topClock_clk]
...
set_property -dict { PACKAGE_PIN G4  IOSTANDARD LVCMOS15 } [get_ports { topClock_resetn }]; #IO_L12N_T1_MRCC_35 Sch=cpu_resetn
...
set_property -dict { PACKAGE_PIN AA19  IOSTANDARD LVCMOS33 } [get_ports { io_uart_transmit }]; #IO_L15P_T2_DQS_RDWR_B_14 Sch=uart_rx_out
#set_property -dict { PACKAGE_PIN V18   IOSTANDARD LVCMOS33 } [get_ports { uart_tx_in }]; #IO_L14P_T2_SRCC_14 Sch=uart_tx_in
set_property -dict { PACKAGE_PIN V18   IOSTANDARD LVCMOS33 } [get_ports { io_uart_receive }]; #IO_L14P_T2_SRCC_14 Sch=uart_tx_in
